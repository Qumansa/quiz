                ...
                <div className="container">
                    <div className="question__counter">
                        ...
                        <span className="question__text">
                            Вопрос <span className="question__number">1</span>/10
                        </span>
                    </div>
                    <p className="question__descr">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta porro eaque aperiam cupiditate rerum debitis ex laborum saepe?</p>
