...
const Quiz = () => {
    ...
    const {data: currentDifficultyNotTransformed = '-'} = useGetCurrentDifficultyQuery();
    const currentDifficulty = transformCurrentDifficulty(currentDifficultyNotTransformed);
    ...
    const {id = '-', description, answers = ['-', '-', '-', '-'], correctAnswer, skipped} = isFetching || isError
        ? {}
        : questionData;
                    ...
                    <div className="question__header">
                        <div className="question__counter">
                            ...
                            <span className="question__text">
                                Вопрос <span className="question__number">{id}</span>/{totalAmountOfQuestions}
                            </span>
                        </div>
                        <span className="question__dofficulty">Уровень сложности: {currentDifficultyNotTransformed}</span>
                    </div>
